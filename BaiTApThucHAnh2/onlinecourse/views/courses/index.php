...
<div class="container">
    ...
    <div class="filter-section" style="margin: 2rem 0;">
        ...
        <select onchange="lọcTheoDanhMục(this.value)" class="form-control" style="max-width: 300px;">
                ...
                <div class="course-card">
                    <div class="course-image">
                        <?php if (!empty($khóa_học['image'])): ?>
                            <img src="assets/uploads/courses/<?php echo htmlspecialchars($khóa_học['image']); ?>" alt="<?php echo htmlspecialchars($khóa_học['title']); ?>">
                        <?php else: ?>
